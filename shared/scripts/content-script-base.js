// Boring YouTube - Base Content Script
// Shared functionality between Firefox and Chromium platforms
...
(function() {
    ...
    function initBase() {
        ...
        console.log('Boring YouTube extension base loaded');
    }
    ...
    // Export functions for platform-specific scripts
    window.BoringYouTubeBase = {
        initBase,
        setupNavigationHandler,
        checkFullscreenState,
        toggleGreyscale,
        DISABLE_GREYSCALE_CLASS
    };
